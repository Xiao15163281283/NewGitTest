...
import vgg_A_conv1_linear1_1,vgg_A
...
class Trainer(object):
    ...
    def __init__(self, config, data_loader):
        ...
        for i in range(self.model_num):
            # build models
            checkpoint_0 = torch.load(r'./model_0.7372/model_best.pth.tar')
            model_0 = vgg_A.vgg16_bn()
            ...
            model_1 = vgg_A_conv1_linear1_1.vgg16_bn()
